...
namespace App\Http\Admin\Owl\Auth;
 ...
 * Class Permission
 *
 * @property \App\Models\Auth\Permission $model
 *
...
class Permission extends Section implements Initializable
{
    ...
    {
        $this->addToNavigation()->setPriority(1002)->setIcon('fa fa-lightbulb-o');
    }
    ...
    public function onDisplay($payload = [])
    {
        ...
        $display->setColumnFilters([
            AdminColumnFilter::select()
                ->setModelForOptions(\App\Models\Auth\Permission::class, 'name')
